  ...
  return (
    <>
      <table className="tableBlock">
        <thead>
          <tr>
            <th className="rowHighlight">Notes</th>
          </tr>
          <tr>
            <td className="taskEntry">Task Details</td>
          </tr>
        </thead>
        <tbody>
          {toDoList.map((item) => {
                ...
                <td className="notesEntry">
                  <span>
                    <input
                      ...
                      value={item.dates[index][currentDate].dayNotes}
                      key={key}
                      onChange={(event) => handleNotesEdit(event, key)}
                    />
                  </span>
                </td>
              </tr>
